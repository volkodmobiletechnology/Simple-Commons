package com.volkod.commons.samples.activities
...
import com.volkod.commons.compose.extensions.config
    ...
    private fun getUpgradeToProAlertDialogState() = rememberAlertDialogState().apply {
        DialogMember {
            UpgradeToProAlertDialog(alertDialogState = this, onMoreInfoClick = {
                launchViewIntent("https://volkodmobiletechnology.com/upgrade_to_pro")
