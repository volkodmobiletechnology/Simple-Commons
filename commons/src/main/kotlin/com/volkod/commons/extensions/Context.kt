...
import com.volkod.commons.models.AlarmSound
import com.volkod.commons.models.BlockedNumber
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.volkod.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.volkod.thankyou")
...
fun Context.isAProApp() = packageName.startsWith("com.volkod.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.volkod."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.volkod.contacts") && !packageName.startsWith("com.volkod.dialer")) {
        true
    } else if ((packageName.startsWith("com.volkod.contacts") || packageName.startsWith("com.volkod.dialer")) && isQPlus()) {
