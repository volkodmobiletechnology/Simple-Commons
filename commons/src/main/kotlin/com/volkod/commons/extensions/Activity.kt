...
import com.volkod.commons.compose.extensions.DEVELOPER_PLAY_STORE_URL
import com.volkod.commons.databinding.DialogTitleBinding
import com.volkod.commons.dialogs.*
import com.volkod.commons.dialogs.WritePermissionDialog.WritePermissionDialogMode
import com.volkod.commons.helpers.*
import com.volkod.commons.models.*
import com.volkod.commons.views.MyTextView
import java.io.*
import java.util.*
...
fun Activity.launchPurchaseThankYouIntent() {
    hideKeyboard()
    try {
        launchViewIntent("market://details?id=com.volkod.thankyou")
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.volkod.gallery.pro" || applicationId == "com.volkod.gallery.pro.debug") {
...
fun BaseSimpleActivity.launchCallIntent(recipient: String, handle: PhoneAccountHandle? = null) {
    handlePermission(PERMISSION_CALL_PHONE) {
        ...
        Intent(action).apply {
            ...
            if (isDefaultDialer()) {
                val packageName = if (baseConfig.appId.contains(".debug", true)) "com.volkod.dialer.debug" else "com.volkod.dialer"
                val className = "com.volkod.dialer.activities.DialerActivity"
