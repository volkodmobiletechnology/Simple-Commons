...
import com.volkod.commons.compose.extensions.onEventValue
import com.volkod.commons.compose.screens.ManageBlockedNumbersScreen
import com.volkod.commons.compose.theme.AppThemeSurface
import com.volkod.commons.dialogs.AddOrEditBlockedNumberAlertDialog
import com.volkod.commons.dialogs.ExportBlockedNumbersDialog
import com.volkod.commons.dialogs.FilePickerDialog
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isDialer = remember {
                config.appId.startsWith("com.volkod.dialer")
            }
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.volkod.dialer")) {
