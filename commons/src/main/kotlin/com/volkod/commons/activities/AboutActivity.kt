...
import com.volkod.commons.compose.extensions.rateStarsRedirectAndThankYou
import com.volkod.commons.compose.screens.*
import com.volkod.commons.compose.theme.AppThemeSurface
import com.volkod.commons.dialogs.ConfirmationAdvancedAlertDialog
import com.volkod.commons.dialogs.RateStarsAlertDialog
import com.volkod.commons.extensions.*
...
class AboutActivity : ComponentActivity() {
    ...
    private fun launchEmailIntent() {
        ...
        val address = if (packageName.startsWith("com.volkod")) {
    ...
    private fun onFacebookClick() {
        var link = "https://www.facebook.com/volkodmobiletechnology"
        try {
    ...
    private fun onGithubClick() {
        launchViewIntent("https://github.com/volkodmobiletechnology")
    }

    private fun onRedditClick() {
        launchViewIntent("https://www.reddit.com/r/volkodmobiletechnology")
    }


    private fun onTelegramClick() {
        launchViewIntent("https://t.me/volkodmobiletechnology")
    }


    private fun onWebsiteClick() {
        launchViewIntent("https://volkodmobiletechnology.com/")
    }

    private fun onPrivacyPolicyClick() {
        val appId = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.volkod.")
        val url = "https://volkodmobiletechnology.com/privacy/$appId.txt"
