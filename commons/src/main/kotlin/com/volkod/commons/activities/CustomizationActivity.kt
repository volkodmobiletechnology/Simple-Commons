...
import com.volkod.commons.databinding.ActivityCustomizationBinding
import com.volkod.commons.dialogs.*
import com.volkod.commons.extensions.*
import com.volkod.commons.helpers.*
import com.volkod.commons.models.MyTheme
import com.volkod.commons.models.RadioItem
import com.volkod.commons.models.SharedTheme
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        isThankYou = packageName.removeSuffix(".debug") == "com.volkod.thankyou"
        initColorVariables()
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.volkod.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
