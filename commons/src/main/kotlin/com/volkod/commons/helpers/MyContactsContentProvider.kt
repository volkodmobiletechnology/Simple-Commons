package com.volkod.commons.helpers
...
import com.volkod.commons.extensions.getIntValue
import com.volkod.commons.extensions.getStringValue
import com.volkod.commons.models.PhoneNumber
import com.volkod.commons.models.SimpleContact
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.volkod.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.volkod.dialer" && packageName != "com.volkod.smsmessenger" && packageName != "com.volkod.calendar.pro") {
                return contacts
            }
